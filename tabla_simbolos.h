...
class TablaSimbolos{
    ...
    void InicializarPalabrasClave(){
        ...
        Insertar("entrada", ENTRADA, "pclave", vacio, vacio);  // NUEVO
        
        // Nuevas palabras clave para estructuras de control
        Insertar("si", KW_IF, "pclave", vacio, vacio);
        Insertar("sino", KW_ELSE, "pclave", vacio, vacio);
        
        // NUEVAS PALABRAS CLAVE PARA SERVO Y ULTRASÓNICO
        Insertar("incluir", INCLUIR, "pclave", vacio, vacio);
        Insertar("libreria", LIBRERIA, "pclave", vacio, vacio);
        Insertar("servo", SERVO, "pclave", vacio, vacio);
        Insertar("conectar", CONECTAR, "pclave", vacio, vacio);
        Insertar("estado", ESTADO, "pclave", vacio, vacio);
        Insertar("pulso", PULSO, "pclave", vacio, vacio);
        Insertar("trigger", TRIGGER, "pclave", vacio, vacio);
        Insertar("echo", ECHO, "pclave", vacio, vacio);
        ...
        Insertar(".", PUNTO, "pclave", vacio, vacio);  // Punto para conectar.puerta
